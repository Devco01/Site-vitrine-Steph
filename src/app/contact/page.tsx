  ...
  return (
    <PageWrapper>
      ...
      <div className="container mx-auto py-12 px-4">
        <div className="bg-gradient-to-b from-white to-gray-100 rounded-lg shadow-md p-6 md:p-8 mb-8">
          <h1 className="text-3xl font-bold text-gray-700 mb-4 pb-2 border-b border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="bg-white p-4 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600 font-bold">06.64.95.30.92</p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow-sm text-center">
              <div className="h-12 w-12 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <div id="contactForm" className="bg-gradient-to-b from-white to-gray-100 rounded-lg shadow-md p-6 md:p-8">
              <h2 className="text-2xl font-bold text-gray-700 mb-4 pb-2 border-b border-gray-200">Demande de devis ou d&apos;information</h2>
              <p className="text-gray-700 mb-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gradient-to-b from-white to-gray-100 rounded-lg shadow-md p-6 md:p-8 h-full">
              <h2 className="text-2xl font-bold text-gray-700 mb-4 pb-2 border-b border-gray-200">Nous Trouver</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a 
                href="tel:0664953092"
                className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1"
              >
              ...
              <a 
                ...
                className="inline-flex items-center justify-center px-6 py-3 border border-gray-600 text-base font-medium rounded-md text-gray-600 bg-white hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
