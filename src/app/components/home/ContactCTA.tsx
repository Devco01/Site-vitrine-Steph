      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-8 md:max-w-4xl mx-auto">
          <FadeIn 
            ...
            delay={0.4} 
            duration={0.6}
            className="bg-white p-6 rounded-lg shadow-lg border border-gray-200 md:w-1/2"
          >
            <h3 className="text-xl font-semibold text-gray-700 mb-4 pb-2 border-b border-gray-200 text-center">
              Nos Horaires d&apos;Ouverture
            </h3>
            <StaggerContainer staggerDelay={0.1}>
              <ul className="space-y-3 text-gray-700 max-w-xs mx-auto">
                <StaggerItem className="flex justify-between items-center p-2 hover:bg-gray-100 rounded-md transition-colors duration-200">
          ...
          <FadeIn 
            ...
            delay={0.2} 
            duration={0.6}
            className="bg-gradient-to-r from-gray-700 to-gray-600 p-6 rounded-lg shadow-lg text-white md:w-1/2"
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 gap-4 max-w-xs mx-auto">
              ...
              >
                <Link href="tel:0664953092" className="flex items-center hover:underline text-sm md:text-base">
                  <svg className="w-5 h-5 md:w-6 md:h-6 mr-2 text-gray-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
